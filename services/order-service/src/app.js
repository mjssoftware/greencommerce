...
const { initializeEventPublishers } = require('./events/publishers/order-event.publisher');
...
// Routes
app.use(`/api/${process.env.API_VERSION || 'v1'}/orders`, require('./routes/v1/order.routes'));
